...
TODO: see after! format [[https://c.pgdm.ch/notes/doom-emacs/][pdgm.ch]] 
...
(use-package! centaur-tabs
  ...
  :config
  ;; (setopt tab-bar-show 1) ;; TODO: test
...
(setq xclip-select-enable-clipboard t)
#+end_src
* Setenv | Fix xclip | org-download-clipboard
#+begin_src emacs-lisp :tangle yes
